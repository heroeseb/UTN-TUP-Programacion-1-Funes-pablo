...
# Ejercicio 6 Categoria del consumo electrico
print("Comienza el ejercicio 6")
consumo = int(input("Dime cual es el consumo mensual de energía eléctrica en kilovatios (kWh): "))
if consumo < 150 and consumo > 0:
    print("Consumo bajo")
